...
impl TextPopup {
    pub fn as_proto() -> WieJavaClassProto {
        WieJavaClassProto {
            ...
            interfaces: vec![],
            methods: vec![
                JavaMethodProto::new("<init>", "(Ljava/lang/String;III)V", Self::init, Default::default()),
                JavaMethodProto::new(
                    "<init>",
            ...
            fields: vec![
                ...
                JavaFieldProto::new("__wieTextPopupActionListener", "Lorg/kwis/msp/lwc/ActionListener;", Default::default()),
            ],
    ...
    async fn init(
        ...
        Self::init_with_display(jvm, context, this, display, data, constraint, mode, caret_position).await
    }
    ...
    async fn set_wide(
        ...
        jvm.put_field(&mut this, "__wieTextPopupActionListener", "Lorg/kwis/msp/lwc/ActionListener;", listener)
            .await?;

        Ok(())
    }

    async fn key_notify(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<TextPopup>, event_type: i32, key: i32) -> JvmResult<bool> {
        ...
        if matches!(event_type, 1..=3) {
            ...
            if action == 8 {
                ...
                let listener: ClassInstanceRef<()> = jvm
                    .get_field(&this, "__wieTextPopupActionListener", "Lorg/kwis/msp/lwc/ActionListener;")
                    .await?;
