...
impl TextFormatProcessor {
    pub fn as_proto() -> WieJavaClassProto {
        WieJavaClassProto {
            ...
            methods: vec![
                ...
                JavaMethodProto::new("getDataHeight", "()I", Self::get_data_height, Default::default()),
                JavaMethodProto::new("setLineWidth", "(I)V", Self::set_line_width, Default::default()),
                JavaMethodProto::new("setData", "([C)I", Self::set_data, Default::default()),
                JavaMethodProto::new("setData", "([CI)I", Self::set_data_with_position, Default::default()),
                JavaMethodProto::new("setWHSize", "(II)I", Self::set_wh_size, Default::default()),
                JavaMethodProto::new("setWHLSize", "(III)I", Self::set_whl_size, Default::default()),
                JavaMethodProto::new("setCurrent", "(I)V", Self::set_current, Default::default()),
                JavaMethodProto::new("getUpDownPosition", "(II)I", Self::get_up_down_position, Default::default()),
                JavaMethodProto::new("paintChar", "(Lorg/kwis/msp/lcdui/Graphics;IIZ)V", Self::paint_char, Default::default()),
                JavaMethodProto::new(
                    "paintChar",
            ...
            fields: vec![
                ...
                JavaFieldProto::new("__wieFont", "Lorg/kwis/msp/lcdui/Font;", Default::default()), // +0x24
    ...
    async fn init(jvm: &Jvm, _: &mut WieJvmContext, mut this: ClassInstanceRef<TextFormatProcessor>) -> JvmResult<()> {
        ...
        let mut line_positions: ClassInstanceRef<Array<i32>> = jvm.instantiate_array("I", 1).await?.into();
        jvm.store_array(&mut line_positions, 0, [0i32]).await?;
        jvm.put_field(&mut this, "__wieLinePositions", "[I", line_positions).await?;
        ...
        jvm.put_field(&mut this, "__wieFont", "Lorg/kwis/msp/lcdui/Font;", font.clone()).await?;

        let height: i32 = jvm.invoke_virtual(&font, "getHeight", "()I", ()).await?;
        jvm.put_field(&mut this, "__wieFontHeight", "I", height.wrapping_add(2)).await?;

        Ok(())
    }

    async fn get_cur_line(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<TextFormatProcessor>) -> JvmResult<i32> {
        jvm.get_field(&this, "__wieCurLine", "I").await
    }

    async fn get_font(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<TextFormatProcessor>) -> JvmResult<ClassInstanceRef<()>> {
        jvm.get_field(&this, "__wieFont", "Lorg/kwis/msp/lcdui/Font;").await
    }

    async fn set_constraints(jvm: &Jvm, _: &mut WieJvmContext, mut this: ClassInstanceRef<TextFormatProcessor>, constraints: i32) -> JvmResult<()> {
        jvm.put_field(&mut this, "__wieConstraints", "I", constraints).await
    }

    async fn get_data(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<TextFormatProcessor>) -> JvmResult<ClassInstanceRef<Array<JavaChar>>> {
        jvm.get_field(&this, "__wieData", "[C").await
    }

    async fn get_data_height(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<TextFormatProcessor>) -> JvmResult<i32> {
        jvm.get_field(&this, "__wieDataHeight", "I").await
    }

    async fn set_line_width(jvm: &Jvm, _: &mut WieJvmContext, mut this: ClassInstanceRef<TextFormatProcessor>, width: i32) -> JvmResult<()> {
    ...
    async fn set_wh_size(jvm: &Jvm, ctx: &mut WieJvmContext, this: ClassInstanceRef<TextFormatProcessor>, width: i32, height: i32) -> JvmResult<i32> {
        Self::set_whl_size(jvm, ctx, this, width, height, width).await
    }
    ...
    async fn rebuild(jvm: &Jvm, mut this: ClassInstanceRef<TextFormatProcessor>, start_position: i32) -> JvmResult<i32> {
        ...
        let chars: alloc::vec::Vec<JavaChar> = jvm.load_array(&data, 0, data_length as usize).await?;
        ...
        // changed position.
        if start_position != 0 {
            let old_line_count: i32 = jvm.get_field(&this, "__wieLineCount", "I").await?;

            if old_line_count > 1 {
                let positions: ClassInstanceRef<Array<i32>> = jvm.get_field(&this, "__wieLinePositions", "[I").await?;
                let capacity = jvm.array_length(&positions).await? as i32;
                let usable = core::cmp::min(old_line_count, capacity);

                if usable > 0 {
                    let old_positions: alloc::vec::Vec<i32> = jvm.load_array(&positions, 0, usable as usize).await?;
                    ...
                    scan_start = old_positions[containing_line].max(0).min(data_length);
        ...
        for index in scan_start..data_length {
            ...
            if accumulated_width > line_width {
                ...
                Self::mark_new_line_position(jvm, this.clone(), index, line_number).await?;
        ...
        jvm.put_field(&mut this, "__wieLineCount", "I", line_number).await?;
        jvm.put_field(&mut this, "__wieDataHeight", "I", data_height).await?;

        Ok(data_height)
    }

    async fn mark_new_line_position(jvm: &Jvm, mut this: ClassInstanceRef<TextFormatProcessor>, position: i32, line_number: i32) -> JvmResult<()> {
        let mut positions: ClassInstanceRef<Array<i32>> = jvm.get_field(&this, "__wieLinePositions", "[I").await?;
        ...
        if line_number > capacity {
            ...
            let mut expanded: ClassInstanceRef<Array<i32>> = jvm.instantiate_array("I", new_capacity as usize).await?.into();

            if capacity > 0 {
                let old_values: alloc::vec::Vec<i32> = jvm.load_array(&positions, 0, capacity as usize).await?;
                jvm.store_array(&mut expanded, 0, old_values).await?;
            }

            jvm.put_field(&mut this, "__wieLinePositions", "[I", expanded.clone()).await?;
    ...
    async fn find_new_position(
        ...
        if current_position > current_line_start && current_line_start < data_length {
            let start = current_line_start.max(0);
            let end = current_position.min(data_length);

            if end > start {
                let chars: alloc::vec::Vec<JavaChar> = jvm.load_array(&data, start as usize, (end - start) as usize).await?;

                for ch in chars {
                    let width: i32 = jvm.invoke_virtual(&font, "charWidth", "(C)I", (ch,)).await?;
        ...
        while position < data_length {
            ...
            let chars: alloc::vec::Vec<JavaChar> = jvm.load_array(&data, position as usize, 1).await?;
            let ch = chars[0];
    ...
    async fn find_line(jvm: &Jvm, this: &ClassInstanceRef<TextFormatProcessor>, position: i32) -> JvmResult<i32> {
        let line_count: i32 = jvm.get_field(this, "__wieLineCount", "I").await?;
        ...
        let values: alloc::vec::Vec<i32> = jvm.load_array(&positions, 0, capacity).await?;
    ...
    async fn set_current(jvm: &Jvm, _: &mut WieJvmContext, mut this: ClassInstanceRef<TextFormatProcessor>, position: i32) -> JvmResult<()> {
        ...
        jvm.put_field(&mut this, "__wieCurrent", "I", position).await?;

        let line = Self::find_line(jvm, &this, position).await?;
        jvm.put_field(&mut this, "__wieCurLine", "I", line).await?;
    ...
    async fn paint_char_default(
        ...
        Self::paint_char(jvm, ctx, this, graphics, 0, 0, draw_caret).await
    }
    ...
    async fn paint_char(
        ...
        if width <= 0 || data.is_null() || data_length == 0 {
            if draw_caret {
                let _: () = jvm
                    .invoke_virtual(&graphics, "drawLine", "(IIII)V", (1i32, 0i32, 1i32, font_height))
                    .await?;
            }
            return Ok(());
        }

        if start_line < 0 || visual_line < 0 || start_line >= line_count || visual_line >= line_count {
            return Ok(());
        }
        ...
        while line < line_count && screen_line < line_count && line < positions_len {
            let start_vec: alloc::vec::Vec<i32> = jvm.load_array(&positions, line as usize, 1).await?;
            let line_start = start_vec[0];

            let line_end = if line + 1 < line_count && line + 1 < positions_len {
                let end_vec: alloc::vec::Vec<i32> = jvm.load_array(&positions, (line + 1) as usize, 1).await?;
                end_vec[0]
            } else {
                data_length
            };
            ...
            while index < end {
                ...
                if ch != 10 {
                    ...
                    if draw_caret && index == current {
                        let _: () = jvm
                            .invoke_virtual(&graphics, "drawLine", "(IIII)V", (x, y, x, y.wrapping_add(font_height)))
                            .await?;
                    }
        ...
        if draw_caret && current >= data_length {
            let _: () = jvm
                .invoke_virtual(
                    ...
                    "drawLine",
                    "(IIII)V",
                    (last_x, last_y, last_x, last_y.wrapping_add(font_height)),
                )
                .await?;
        }
    ...
    async fn get_up_down_position(
        ...
        let current_start: alloc::vec::Vec<i32> = jvm.load_array(&positions, current_line as usize, 1).await?;
        let target_start: alloc::vec::Vec<i32> = jvm.load_array(&positions, target_line as usize, 1).await?;

        Self::find_new_position(jvm, &this, target_start[0], position, current_start[0]).await
    }
